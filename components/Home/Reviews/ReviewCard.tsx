...
import { FaQuora, FaStar } from 'react-icons/fa'
...
const ReviewCard = ({review}: Props) => {
  return (
    <div className="bg-white rounded-lg m-3 p-6 relative">
      <FaQuora className='w-8 h-8 absolute t-4 right-4 text-red-600 opacity-20' />
      ...
      <div className='flex items-center space-x-4'>
        ...
        <div>
            <h1 className='font-bold tex-gray-800'>{review.name}</h1>
