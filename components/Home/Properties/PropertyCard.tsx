...
import { FaBed, FaSquare, FaBath } from 'react-icons/fa';
  ...
  return (
    <div className="bg-white overflow-hidden group rounded-lg cursor-pointer shadow-lg">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center mt-6 justify-between w-full lg:w-[50%]">
          ...
          <div className="flex items-center space-x-2">
            ...
            <p className="text-xs text-gray-600">{property.bathrooms} Cr</p>
          </div>
          <div className="flex items-center space-x-2">
